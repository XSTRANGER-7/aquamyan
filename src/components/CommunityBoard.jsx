...
//   const [request, setRequest] = useState({ name: '', location: '', resourceNeeded: '' }); 
...
//   const addLongTermPlan = () => {
//     setPlans([...plans, longTermPlan]);
//     setLongTermPlan({ title: '', description: '' });
//   };

//   const sendMessage = () => {
//     if (message.trim()) {
//       setMessages([...messages, { content: message, sender: request.name || 'Anonymous' }]);
//       setMessage('');
//     }
//   };

//   return (
//     <div className="min-h-screen p-6 bg-gradient-to-r from-blue-100 to-green-100 flex flex-col items-center">
//       <h2 className="text-3xl font-bold mb-8 text-center text-gray-800">Community Resilience and Recovery</h2>
...
//       >
//         <h3 className="text-2xl font-semibold mb-4 text-green-600">Long-Term Recovery Planning</h3>
//         <input 
//           type="text"
//           name="title"
...
//             <li key={index} className="bg-green-50 p-4 rounded-lg mb-2 shadow">
//               <p><strong>{plan.title}</strong>: {plan.description}</p>
//             </li>
//           ))}
//         </ul>
//       </motion.div>
...
//         transition={{ duration: 0.5 }}
//       >
//         <h3 className="text-2xl font-semibold mb-4 text-purple-600">Community Chat</h3>
//         <input 
//           type="text"
...
//         <button 
//           onClick={sendMessage} 
//           className="bg-purple-500 text-white rounded-lg py-2 w-full"
//         >
//           Send Message
//         </button>
...
//             <li key={index} className="bg-purple-50 p-4 rounded-lg mb-2 shadow">
...
// const AIRTABLE_API_KEY = 'patf4qfNj9vhCYUHL.f4768e614d6c2a02ec18094efdeaf3f3e22aea01765b7ace9a87bb0cc8bc0aac';
// const AIRTABLE_BASE_ID = 'appH3hlm3RoJJbcoa';
...
//     try {
//       const response = await fetch(`${AIRTABLE_API_URL}/Plans`, {
//         headers: {
...
//       setPlans(data.records.map(record => record.fields));
//     } catch (error) {
...
//     try {
//       const response = await fetch(`${AIRTABLE_API_URL}/Messages`, {
//         headers: {
//           Authorization: `Bearer ${AIRTABLE_API_KEY}`,
//           'Content-Type': 'application/json',
//         },
//       });
//       const data = await response.json();
//       setMessages(data.records.map(record => record.fields));
//     } catch (error) {
...
//       try {
//         await fetch(`${AIRTABLE_API_URL}/Plans`, {
//           method: 'POST',
//           headers: {
//             Authorization: `Bearer ${AIRTABLE_API_KEY}`,
//             'Content-Type': 'application/json',
//           },
//           body: JSON.stringify({ fields: longTermPlan }),
//         });
//         setPlans([...plans, longTermPlan]);
//         setLongTermPlan({ title: '', description: '' });
//       } catch (error) {
...
//       try {
//         await fetch(`${AIRTABLE_API_URL}/Messages`, {
//           method: 'POST',
//           headers: {
//             Authorization: `Bearer ${AIRTABLE_API_KEY}`,
//             'Content-Type': 'application/json',
//           },
//           body: JSON.stringify({ fields: newMessage }),
//         });
...
//   return (
//     <div className="min-h-screen p-6 bg-gradient-to-r from-blue-100 to-green-100 flex flex-col items-center">
//       <h2 className="text-4xl font-bold mb-8 text-center text-gray-800">Community Resilience and Recovery</h2>
